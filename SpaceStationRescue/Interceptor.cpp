...
Interceptor::Interceptor() : BaseAI(1)
{
	startPoint = 0;
}

Interceptor::Interceptor(sf::Vector2f position, sf::Vector2f velocity, sf::Vector2f maxSpeed, sf::Texture *texture)
{
	m_position = position;
	m_velocity = velocity;
...
float Interceptor::getTimeAlive()
{
	return timeAlive;
}
